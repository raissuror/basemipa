    ...
    <div id="sidebar" class="sidebar">
      ...
      <div class="app-brand">
        <a href="/home" title="Basemipa">
          <img src="{{ asset('img/brand/logo_web.png') }}" class="navbar-brand-img" style="width:2vw;">
      ...
      <div class="sidebar-scrollbar">
        ...
        <ul class="nav sidebar-inner" id="sidebar-menu">
          ...
          <li class="has-sub">
            <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#himpunan" aria-expanded="false" aria-controls="himpunan">
              <i class="mdi mdi-human-male-female"></i>
              <span class="nav-text">Anggota Kema</span> <b class="caret"></b>
            </a>
            <ul class="collapse" id="himpunan" data-parent="#sidebar-menu">
              <div class="sub-menu">
                <li>
